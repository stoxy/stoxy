# -*- coding: utf-8 -*-
#
# Stoxy documentation build configuration file, created by
# sphinx-quickstart on Thu Dec 22 08:04:28 2011.
#
...
sphinx.apidoc.main('sphinx-api -o gen ../../stoxy'.split())
...
copyright = u'2013-2014, Stoxy developers'
...
latex_documents = [
  ('index', 'stoxy.tex', u'Stoxy Documentation',
   u'Ilja Livenson', 'manual'),
]
